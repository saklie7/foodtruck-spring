...
update truck set t_name='aa', t_image='1510189707108default-truck.jpg',
 t_comment='1', t_open='1', t_close='1', 
  t_foodmaterial='1' where t_id=1;
...
insert into support(s_title, s_content, s_date, s_registype, s_member) values('이용관련문의1', '1-사업자이용관련문의드립니다.', CURDATE(), '1', 'bb@bb.com');
